...
namespace Flow
{
    ...
    void NArrayCore::BackwardGather()
    {
        ...
        BackwardGather_Kernel<<< n, 1 >>>( gradient_d, operandShape_d, Operands[0]->GetShape().size(), operandGradient_d, GatherDim, index_d, indexShape_d, GatherIndex->GetShape().size() );

...
__global__
void BackwardReLU_Kernel( Flow::NArrayDevice* grad, Flow::NArrayDevice* operand,
...
void Flow::NArray::BackwardReLU()
{
    ...
    BackwardReLU_Kernel<<< BLOCKS(n), TPB >>>( Gradient->DeviceStruct, Operands[0]->DeviceStruct,

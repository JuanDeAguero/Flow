...
__global__
void BackwardExp_Kernel( Flow::NArrayDevice* grad, Flow::NArrayDevice* operand,
...
void Flow::NArray::BackwardExp()
{
    ...
    BackwardExp_Kernel<<< BLOCKS(n), TPB >>>( Gradient->DeviceStruct, Operands[0]->DeviceStruct,

...
static bool Test_ReLU()
{
    ...
    Test( 1, numPassed,
        Flow::Create( { 2, 2, 2, 2 }, { -0.5, 1.5, -1, 2, 1.5, -1.5, 2.5, -2.5, 0, 0, 0, 0, 0, 0, 0, 0 } ), Flow::NArray(), {}, {}, {}, {}, op,
    ...
    Test( 2, numPassed,
        Flow::Create( { 2, 2, 2 }, { -0.5, 1.5, -1, 2, 1.5, -1.5, 2.5, -2.5 } ), Flow::NArray(), {}, {}, {}, {}, op,
    ...
    Test( 3, numPassed,
        Flow::Create( { 3, 3 }, { -1, 1, 0, 2, -2, 2.5, -0.5, 0, 3 } ), Flow::NArray(), {}, {}, {}, {}, op,
        { 0, 1, 0, 2, 0, 2.5, 0, 0, 3 },
        { 3, 3 },
        { 0, 1, 0, 1, 0, 1, 0, 0, 1 },
        { 3, 3 }, {}, {} );
    ...
    Test( 4, numPassed,
        Flow::Create( { 5 }, { -1, 1, 0, 2, -2 } ), Flow::NArray(), {}, {}, {}, {}, op,
        { 0, 1, 0, 2, 0 },
        { 5 },
        { 0, 1, 0, 1, 0 },
        { 5 }, {}, {} );

...
static bool Test_Exp()
{
    int numPassed = 0;
    int numTests = 5;
    Flow::NArrayCore::Operation op = Flow::NArrayCore::Operation::EXP;

    Test( 1, numPassed,
        Flow::Create( { 2, 4 }, { 5, 7, 8, 9, 3, 4, 5, 4 } ), nullptr, {}, {}, {}, {}, op,
    ...
    Test( 2, numPassed,
        Flow::Create( { 3 }, { 1, 2, 3 } ), nullptr, {}, {}, {}, {}, op,
    ...
    Test( 3, numPassed,
        Flow::Create( { 2, 2 }, { 0, -1, -2, -3 } ), nullptr, {}, {}, {}, {}, op,
    ...
    Test( 4, numPassed,
        Flow::Create( { 1, 4 }, { -1, 0, 1, 2 } ), nullptr, {}, {}, {}, {}, op,
    ...
    Test( 5, numPassed,
        Flow::Create( { 2, 2, 2 }, { 0, 1, -1, 2, 1.5, -1.5, 2.5, -2.5 } ), nullptr, {}, {}, {}, {}, op,

...
static bool Test_Exp()
{
    ...
    Test( 1, numPassed,
        Flow::Create( { 2, 4 }, { 5, 7, 8, 9, 3, 4, 5, 4 } ), Flow::NArray(), {}, {}, {}, {}, op,
    ...
    Test( 2, numPassed,
        Flow::Create( { 3 }, { 1, 2, 3 } ), Flow::NArray(), {}, {}, {}, {}, op,
    ...
    Test( 3, numPassed,
        Flow::Create( { 2, 2 }, { 0, -1, -2, -3 } ), Flow::NArray(), {}, {}, {}, {}, op,
    ...
    Test( 4, numPassed,
        Flow::Create( { 1, 4 }, { -1, 0, 1, 2 } ), Flow::NArray(), {}, {}, {}, {}, op,
